...
const PostCard: React.FC<PostCardProps> = ({ post }) => {
  ...
  const [activeLikeBtn, setActiveLikeBtn] = useState<'none' | 'like'>('none');
  const [activeDisLikeBtn, setActiveDisLikeBtn] = useState<'none' | 'dislike'>('none');
    ...
    <div className='other__card'>
      ...
      <div className='other__card--text'>
        ...
        <div className='post__main--rate'>
          ...
          <button className='btn-reset other__card--btn'>Читать дальше</button>
        </div>
